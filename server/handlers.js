...
MongoClient.connect(
  "mongodb+srv://kendra:123@cluster0-khmla.mongodb.net/test?retryWrites=true&w=majority",
  {
...
const createUser = async (req, res) => {
  ...
  if (returningUser) {
    ...
    const appUsersRef = db.ref("app.Users");
...
module.exports = { getDogs, test, createUser };
